...
//
//        Member foundMember = memberService.findMemberByLoginId(loginId).orElseThrow(()->new UserNotFoundException("없는 회원 입니다.",HttpStatus.NOT_FOUND));
//
//        return foundMember;
//    }
    ...
    public Member updateMember(@PathVariable String loginId, @RequestBody UpdateMemberDTO umd) {
        return memberService.updateMember(loginId, umd);
    }
